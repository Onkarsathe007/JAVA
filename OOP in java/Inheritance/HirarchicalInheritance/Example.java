// Only one base and and more than one child class is known as a Hierarchical of inheritance .
...
class Worker extends Human{  //Child class.

}

class CEO extends Human{//Child class.
